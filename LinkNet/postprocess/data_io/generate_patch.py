...
if __name__ == "__main__":
    crop_size=(3000, 3000)
    steps=(1024, 1024)
    save_root = "./output/patchs/base-final"
    train_valid_image_path = "/apdcephfs/private_loktarxiao/projects/U-RISC/data/complex/train"
    test_image_path = "/apdcephfs/private_loktarxiao/projects/U-RISC/data/complex/val"
    label_path = "/apdcephfs/private_loktarxiao/projects/U-RISC/data/complex/label"
    ...
    train_img_lst = glob("/apdcephfs/private_loktarxiao/projects/U-RISC/output/feature_map/linknet-1024-3channel/train/*")
    valid_img_lst = glob("/apdcephfs/private_loktarxiao/projects/U-RISC/output/feature_map/linknet-1024-3channel/valid/*")
    test_img_lst = glob("/apdcephfs/private_loktarxiao/projects/U-RISC/output/feature_map/linknet-1024-3channel/test/*")

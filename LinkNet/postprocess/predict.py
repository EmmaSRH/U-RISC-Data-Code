...
model.load_weights("saved_weights/linknet-resnet18-base/model-97-0.6297.h5")
mode = "valid"


save_dir = os.path.join("result/{}/base-random_coord".format(mode))
os.makedirs(save_dir, exist_ok=True)
folder_lst = glob("/apdcephfs/private_loktarxiao/projects/U-RISC/postprocess/data_io/output/patchs/base-final/{}/*".format(mode))

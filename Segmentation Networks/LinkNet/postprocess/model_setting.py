...
from seg_models.losses import bce_jaccard_loss, binary_focal_dice_loss
from seg_models.metrics import iou_score, f1_score
...
PRETRAINED_WEIGHTS = "saved_weights/base_model.h5"
WEIGHTS_PATH = "saved_weights/linknet-resnet18-3channel-org-3000"
WEIGHTS_FINAL = os.path.join(WEIGHTS_PATH, "model-{epoch:02d}-{val_dice_coef:.4f}.h5")

os.makedirs(WEIGHTS_PATH, exist_ok=True)

def cb_lrschedule():
    scheduler = lambda x: lr_schedule(x, CYCLE=30, LR_INIT=0.0005, LR_MIN=0.00001)
